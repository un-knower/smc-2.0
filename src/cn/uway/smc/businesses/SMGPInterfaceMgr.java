...
import cn.uway.smc.sender.SmgpParaMgr;
...
public class SMGPInterfaceMgr {
	...
	public int SMGPSendSingle(String sDestTermID, String msgContent) {
		...
		try {
			...
			String sChargeTermID = SmgpParaMgr.getInstance().getSpNumber();

			//String sDestTermID = "13316905278";

			String sReplyPath = SmgpParaMgr.getInstance().getSpNumber();
	...
	public static void main(String[] args) {
		// SMGPInterfaceMgr mgr = new SMGPInterfaceMgr();
		// System.out.println(mgr.getSmsPath());
	}
}
