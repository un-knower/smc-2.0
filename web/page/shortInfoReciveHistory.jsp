			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                		  ...
                		  <li><a href="/page/shortInfoReciveHistory.do?action=queryList" class="active">短消息接收历史数据</a></li>   
                ...
                <table cellpadding="0" cellspacing="0">
                                ...
                                <th style="width:8%">操作</th>  
								            ...
								            <c:forEach items="${requestScope.result.data.datas}" var="x">
										         <c:if test="${x!=null}">                                       
								                                ...
								                                <td>${x.fromUser}</td>
								                               <!-- <td>${x.receiveTime}</td>-->
								                                <td>${x.stampTimeTmp}</td>
								                                <td>${fn:substring(x.content, 0, 8)}</td>
								                                <td>${x.result eq 1 ? "成功" : "失败"}</td>
								                                <td>${x.cause}</td>
								                                <td class="action"><a href="shortInfoReciveHistory.do?action=viewInfo&id=${x.id}" class="view">详情</a></td>
								                       </tr>    
								             </c:if>
								          </c:forEach>                            
                        </table>
                         <div align="center">								
															...
															pageIndex="${requestScope.result.wparam.pageIndex}" navigationUrl="/page/shortInfoReciveHistory.do"
