	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                		  <li><a href="/page/shortInfo.do?action=queryList">短消息数据</a></li>     
                		  <li><a href="/page/shortInfoRecive.do?action=queryList" class="active">短消息接收数据</a></li>   
                			<li><a href="/page/expresstInfo.do?action=queryList">快递短消息数据</a></li>                    	
                  </ul>
                    <!-- // .sideNav -->
                </div>    
                <!-- // #sidebar -->
                ...
                <table cellpadding="0" cellspacing="0">
								             ...
								             <c:forEach items="${requestScope.result.data.datas}" var="x">
										                <c:if test="${x!=null}">     
								                           	<tr class="odd">
								                                <td>${x.id}</td>
								                                <td>${x.fromUser}</td>
								                                <td>${x.receiveTimeTmp}</td>
								                                <td>${x.content}</td>
								                                <td class="action"><a href="shortInfoRecive.do?action=viewInfo&id=${x.id}" class="view">详情</a></td>
								                            </tr>
								                    </c:if>
								            </c:forEach>                                                                   							         						                   
                        </table>
                         <div align="center">								
														...
														pageIndex="${requestScope.result.wparam.pageIndex}" navigationUrl="/page/shortInfoRecive.do"
