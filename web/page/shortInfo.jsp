	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                		  <li><a href="shortInfo.do?action=queryList" class="active">短消息数据</a></li>     
                		  <li><a href="/page/shortInfoRecive.do?action=queryList">短消息接收数据</a></li>   
                			<li><a href="expresstInfo.do?action=queryList">快递短消息数据</a></li>                    	
                  </ul>
                    <!-- // .sideNav -->
                </div>    
                <!-- // #sidebar -->
                ...
                <table cellpadding="0" cellspacing="0">
                                ...
                                <th style="width:15%">消息生产时间</th>  
                                <th style="width:15%">消息内容</th>  
                                <th style="width:15%">发送成功次数</th>  
            ...
            <c:forEach items="${requestScope.result.data.datas}" var="x">           
		         <c:if test="${x!=null}">   
                	<tr class="odd">
                                ...
                                <td>${x.content}</td>
                                <td>${x.sentOkTimes}</td>
                                <td class="action"><a href="shortInfo.do?action=viewInfo&id=${x.id}" class="view">详情</a></td>
                            </tr>   
             </c:if>
          </c:forEach>                 
                ...
                <div align="center">								
									<n:nav pageCount="${requestScope.result.wparam.pageCount}"
										pageIndex="${requestScope.result.wparam.pageIndex}" navigationUrl="/page/shortInfo.do"
