					 ...
					 <form action="" method="post" class="jNice">
					 	...
					 	<table cellpadding="0" cellspacing="0">
                    		  ...
                    		  <tr>
                    		       ...
                    		       <tr>
                    				<td>消息生存时间:</td>
                    				<td>${requestScope.result.data.ttl}  (分钟)</td>
                    		  </tr>
                    		      <tr>
                    				<td>发送偏移时间:</td>
                    				<td>${requestScope.result.data.endoOffsetTime} (分钟)</td>
                    		  </tr>
                    		      <tr>
                    				<td>发送次数:</td>
                    				<td>${requestScope.result.data.sendTimes}</td>
                    		  </tr>
                    		         <tr>
                    				<td>时间间隔:</td>
                    				<td>${requestScope.result.data.sendInterval}  (分钟)</td>
                    		  </tr>
                    		        <tr>
                    				<td>发送方式:</td>
                    		      ...
                    		      <tr>
                    				<td>当发送失败时是否重发:</td>
                    				<td>${requestScope.result.data.resendWhenFail eq 1?"是":"否"}</td>
                    		  </tr>       
                    		   <tr>
                    				<td>是否生效:</td>
                    				<td>${requestScope.result.data.takeEffect eq 1?"有效":"无效"}</td>
                    		  </tr>
            </table>
